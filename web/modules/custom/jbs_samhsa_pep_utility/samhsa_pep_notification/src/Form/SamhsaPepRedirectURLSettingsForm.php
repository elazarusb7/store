...
/**
 * Class SamhsaPepRedirectURLSettingsForm.
 */
class SamhsaPepRedirectURLSettingsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'samhsa_pep_notification.settings',
    ];
  }
  ...
  public function getFormId() {
    return 'samhsa_pep_redirect_url_admin_settings';
  }

...
/**
* @file
* Contains \Drupal\samhsa_pep_daily_prod_report_download/Form/SAMHSAPepProdRptDownloadSettingsForm.
*/
...
class SAMHSAPepProdRptDownloadSettingsForm extends ConfigFormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['samhsa_daily_prod_report_download_hour'] = array(
            '#type' => 'number',
            '#title' => t('Hour'),
            '#default_value' => $hour,
            '#size' => 4,
        ...
        $path_to_save = $this->config('samhsa_pep_daily_prod_report_download.settings')
            ->get('path_to_save');
        $form['path_to_save'] = array(
            '#type' => 'textfield',
            '#title' => t('Report Download Directory'),
            '#default_value' => isset($path_to_save) ? $path_to_save : 'public://publication_transactions_rpt/',
            '#size' => 60,
            //'#maxlength' => 15,
        ...
        $form['file_name_prefix'] = array(
            '#type' => 'textfield',
            '#title' => t('Report File Name Prefix'),
            '#default_value' => isset($file_name_prefix) ? $file_name_prefix : 'Product-Status-Report-',
            '#size' => 60,
        ...
        $form['last_pub_trans_rpt_date'] = array(
            '#type' => 'textfield',
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $this->config('samhsa_pep_daily_prod_report_download.settings')
            ->set('samhsa_daily_prod_report_download_hour', isset($values['samhsa_daily_prod_report_download_hour']) ? $values['samhsa_daily_prod_report_download_hour'] : 'oz')

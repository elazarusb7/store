...
SET `billing_address_address_line1`       = '4222 Clinton Way',
    `billing_address_organization`        = 'Raven Way',
...
SET `address_address_line1`       = '4222 Clinton Way',
    `address_organization`        = 'Acme Corp',
    `address_given_name`          = 'Wiley',
    `address_family_name`         = 'Coyote'
;

-- profile_revision__address
UPDATE `profile_revision__address`
SET `address_address_line1`       = '2030 Veronica Pl',
    `address_organization`        = 'Seven Gables',
